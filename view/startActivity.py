...
class StartActivity():
    ...
    def __init__(self, screen, gm_setting):
        ...
        self.gm_description_rect.top = self.screen_rect.top + (self.interspace + self.height) * 1 + self.interspace
        ...
        self.gm_rank_rect.top = self.screen_rect.top + (self.interspace + self.height) * 2 + self.interspace
